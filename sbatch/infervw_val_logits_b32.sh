#!/bin/bash
#SBATCH --job-name=infervw_val_logits_b32           # 任务名
...
python -u vizwiz_inference_logits.py --split val --weights /gpfsnyu/scratch/yw3642/lang-seg/checkpoints/lseg_vizwiz_l16_640_512_unf_text_b32/version_0/checkpoints/result-epoch=21-val_acc_epoch=0.84.ckpt \
