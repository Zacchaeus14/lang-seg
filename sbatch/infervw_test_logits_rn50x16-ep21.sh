#!/bin/bash
#SBATCH --job-name=infervw_test_logits_rn50x16-ep21           # 任务名
...
python -u vizwiz_inference_logits.py --split test --weights /gpfsnyu/scratch/yw3642/lang-seg/checkpoints/lseg_vizwiz_l16_640_512_unf_text_rn50x16/version_0/checkpoints/result-epoch=21-val_acc_epoch=0.85.ckpt \
