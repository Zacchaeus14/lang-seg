#!/bin/bash
#SBATCH --job-name=trainvw_unf_text_b32           # 任务名
...
wandb offline
python -u train_lseg.py --dataset vizwiz --data_path ../datasets --batch_size 1 --exp_name lseg_vizwiz_l16_640_512_unf_text_b32 \
--base_lr 0.004 --weight_decay 1e-4 --no-scaleinv --max_epochs 50 --widehead --accumulate_grad_batches 2 --backbone clip_vitb32_384 \
--unfreeze_text
echo "FINISH"                       # 输出起始信息
